const navbarHTML = `<nav class="navbarchild border-gray-200d h-auto bg-transparent fixed top-0 w-full z-50">
  ...
  <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
      <button onclick="window.location.href = '../../Pages/contactus/contactUs.html'"type="button" class="text-white bg-mainOrange hover:bg-darkOrange  md:block focus:ring-4 focus:outline-none  font-medium rounded-lg text-sm px-4 py-2 text-center  focus:ring-blue-800">Get started</button>
