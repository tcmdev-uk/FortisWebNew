const navbarHTML = `<nav class=" border-gray-200d h-auto dark:bg-transparent fixed top-0 w-full z-50">
  ...
  <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
      <button onclick="window.location.href = '../Pages/contactus/contactUs.html'"type="button" class="text-white bg-mainOrange hover:bg-darkOrange hidden md:block focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-mainOrange dark:hover:bg-darkOrange dark:focus:ring-blue-800">Get started</button>
  ...
  <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
    <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border bg-darkAlt md:bg-transparent border-gray-100 rounded-lg text-white md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0  md:dark:bg-transparent  dark:border-gray-700">
      <li>
        <a href="../../index.html" class="block py-2 px-3 md:p-0 text-white  bg-mainOrange rounded md:bg-transparent md:text-mainOrange md:dark:text-mainOrange" aria-current="page">Home</a>
      </li>
      <li>
      ...
      <li>
        <a href="../Pages/contactus/contactUs.html" class="block py-2 px-3 md:p-0 rounded text-dark md:text-white hover:bg-gray-700 hover:text-white md:hover:bg-transparent md:hover:text-blue-700 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Contact</a>
      </li>
    </ul>
  </div>
  </div>
