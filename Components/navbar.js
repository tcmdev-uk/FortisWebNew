const navbarHTML = `<nav class=" border-gray-200d h-auto dark:bg-transparent fixed top-0 w-full z-50">
  ...
  <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
      <button type="button" class="text-white bg-mainOrange hover:bg-darkOrange hidden md:block focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-mainOrange dark:hover:bg-darkOrange dark:focus:ring-blue-800">Get started</button>
